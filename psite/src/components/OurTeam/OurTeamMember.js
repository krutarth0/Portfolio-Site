...
import "../../static/Our_team/Member.css"
    ...
    return (
      ...
      <span className="info">
        ...
        <a href={props.fb}><svg 
            ...
            className="member_fb svg-inline--fa fa-facebook-f fa-w-10" 
            role="img" 
       ...
       <a href={props.twt}><svg 
            aria-hidden="true" 
            focusable="false" 
            data-prefix="fab" 
            data-icon="twitter" 
            className="member_twt svg-inline--fa fa-twitter fa-w-16" 
            role="img" 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 512 512">
       ...
       <a href={props.ig}><svg 
            ...
            data-prefix="fab" 
            data-icon="instagram" 
            className="member_ig svg-inline--fa fa-instagram fa-w-14" 
            role="img" 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 448 512">
